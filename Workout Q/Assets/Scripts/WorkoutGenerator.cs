...
public class WorkoutGenerator : MonoBehaviour {
    ...
    //EXAMPLE WORKOUTS FOR BETA
	[HideInInspector] public WorkoutData ExampleChestTricep;
	[HideInInspector] public WorkoutData ExampleBackBicep;
	[HideInInspector] public WorkoutData ExampleLegs;
	[HideInInspector] public WorkoutData ExampleShoulders;
	[HideInInspector] public WorkoutData ExampleCore;
